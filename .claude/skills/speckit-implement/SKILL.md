...
2. **Check checklists status** (if FEATURE_DIR/checklists/ exists):
    ...
    - **If any checklist is incomplete**:
        ...
        - **STOP** and ask: "Some checklists are incomplete. Do you want to proceed with implementation anyway? (
          yes/no)"
...
10. **Check for extension hooks**: After completion validation, check if `.specify/extensions.yml` exists in the project
    root.
